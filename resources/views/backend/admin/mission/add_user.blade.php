            ...
            <div class="card">
              <div class="card-header">
                <h4>Add mission 
                  ...
                  <a href="{{ route('view_mission') }}" style="float: right;"  class="btn btn-primary">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-10 m-auto">
                    <div class="card p-4">
                      <form action="{{ (@$editSlide)?route('update_mission',$editSlide->id):route('store_mission') }}" method="post" enctype="multipart/form-data" id="quickForm">
                        @csrf              
                        <div class="row">                                                 
                           <div class="col">
                            <div class="row">
                                ...
                                <label for="exampleFormControlInput1" class="form-label">Old image</label>
                                  <div class="mb-3" style="width: 200px;height:150px;">
                                      <img style="width: 250px;height:150px;" id="showImage" class="profile-user-img "
                                        src="{{(@$editSlide)?url('upload/mission/'.$editSlide->image) : url('image/avatar.png')}}"
