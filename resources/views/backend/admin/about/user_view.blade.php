                    ...
                    <table class="table table-striped table-hover" border="2">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                <a href="{{ route('edit_about',$user->id) }}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                <a href="{{ route('delete_about',$user->id) }}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                              </td>
                          </tr>  
                          @endforeach
